...
public class Util {
    ...
    public static void addUniqIdx(MongoClient mongoClient, String db, String colName, Bson UniqIdxBson) {

        try{
            mongoClient.getDatabase(db).getCollection(colName).createIndex(UniqIdxBson, new IndexOptions().unique(true));
